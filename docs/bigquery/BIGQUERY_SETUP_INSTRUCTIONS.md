...
**⚠️ VIKTIGT:** Detta är Flocken-specifik dokumentation. För delad BigQuery projekt-dokumentation, se:  
...
- Välj project: `nastahem-tracking` (delat projekt, se [spitakolus/tracking/BIGQUERY_SHARED_PROJECT.md](https://github.com/tbinho/spitakolus/tree/main/tracking))
