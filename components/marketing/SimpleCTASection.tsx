...
export function SimpleCTASection({
  ...
  offer // Will be undefined for Variant C, which is fine - we have default below
        ...
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <a
              ...
              onClick={() => trackAppInstall('android', 'cta_section')}
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-flocken-olive rounded-xl font-semibold text-lg hover:bg-flocken-cream transition-all hover:scale-105 shadow-soft"
              onClick={() => trackAppInstall('ios', 'cta_section')}
            >
              <svg className="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Offer - default to "gratis premium" (OK längre ner på sidan) */}
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 max-w-md mx-auto">
            <p className="text-white font-semibold">
              {offer || 'Testa premiumfunktioner gratis i 6 månader'}
            </p>
          </div>
        </div>
      </div>
