    ...
    <article className="flex h-full flex-col overflow-hidden rounded-[var(--quiz-radius-card)] border border-flocken-warm/40 bg-white shadow-soft transition-shadow hover:shadow-card">
      ...
      <div className="flex flex-1 flex-col justify-between p-5">
        ...
        <div className="mt-4 space-y-3">
          ...
          <Link
            href={`/quiz/${quiz.slug}`}
            className="inline-flex w-full items-center justify-center gap-1.5 rounded-[var(--quiz-radius-card)] bg-[var(--quiz-color-primary)] px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-flocken-male"
          >
            Starta quiz
