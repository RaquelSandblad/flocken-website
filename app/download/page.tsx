      ...
      <div className="max-w-2xl w-full space-y-8 text-center">
        <div className="space-y-4">
          ...
          <p className="text-lg text-flocken-brown opacity-80">
            Om du inte skickas vidare automatiskt, välj din appbutik:
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href={APPSTORE_URL}
            onClick={() => trackAppInstall('ios', 'download_page')}
          ...
          <a
            href={PLAYSTORE_URL}
            onClick={() => trackAppInstall('android', 'download_page')}
            className="btn-primary inline-flex items-center justify-center"
          >
            <svg className="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 p-6 bg-flocken-sand rounded-2xl">
          <p className="text-sm text-flocken-brown opacity-75">
            <strong>Tips:</strong> Använd den här länken i QR-koder, annonser och på webben:{" "}
            <code className="bg-white px-2 py-1 rounded text-flocken-olive font-mono text-xs">
              /download
            </code>
          </p>
        </div>
